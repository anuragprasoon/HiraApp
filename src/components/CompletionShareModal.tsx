...
export default function CompletionShareModal({ habit, onClose }: CompletionShareModalProps) {
  ...
  const handleShare = async (platform: 'instagram' | 'twitter' | 'whatsapp') => {
    ...
    // Award 0.5 Hira bonus for sharing (only once per completion)
    if (!bonusAwarded) {
      const user = getUser();
      if (user) {
        user.totalHira = (user.totalHira || 0) + 0.5;
        saveUser(user);
  ...
  return (
    ...
    >
      <div 
        className="bg-white p-6 max-w-md w-full shadow-2xl relative max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-yellow-400 to-orange-500 mb-4">
        ...
        {/* Social Share Bonus Message */}
        <div className="mb-6 bg-blue-50 p-4 border border-blue-200">
          <div className="flex items-center gap-3">
            <span className="text-xl">📱</span>
            <p className="text-sm text-gray-700">
               Get <span className="font-bold text-blue-600">0.5 extra Hira</span> for sharing on social media!
            </p>
          </div>
        </div>
            ...
            {posterImage ? (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8">
                  {/* Badge */}
                  <div className="w-24 h-24 bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center mb-4 shadow-lg">
                    <span className="text-4xl">🏆</span>
                  </div>
        ...
        <div className="mb-6 space-y-3">
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold text-lg hover:from-blue-600 hover:to-purple-600 transition-all shadow-lg flex items-center justify-center gap-2"
          >
          ...
          {showShareOptions && (
            <div className="grid grid-cols-3 gap-3 animate-in fade-in duration-200">
              <button
                ...
                className="py-3 bg-gradient-to-br from-purple-500 to-pink-500 text-white font-medium hover:shadow-lg transition-all text-sm flex flex-col items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="py-3 bg-gradient-to-br from-blue-400 to-cyan-500 text-white font-medium hover:shadow-lg transition-all text-sm flex flex-col items-center justify-center gap-2"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="py-3 bg-gradient-to-br from-green-500 to-emerald-500 text-white font-medium hover:shadow-lg transition-all text-sm flex flex-col items-center justify-center gap-2"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-6">
          ...
          <button
            ...
            className="w-full py-3 border-2 border-dashed border-gray-300 hover:border-blue-500 transition-colors flex items-center justify-center gap-2 text-gray-600"
          >
        ...
        <button
          onClick={onClose}
          className="w-full py-3 bg-gray-100 text-gray-700 font-medium hover:bg-gray-200 transition-all"
        >
          Maybe Later
        </button>
      </div>
